...
package com.dongfang.utils.core;
 ...
 * <p/>
 * <p>
 * AsyncTask is designed to be a helper class around {@link Thread} and {@link android.os.Handler} and does not
 * constitute a generic threading framework. AsyncTasks should ideally be used for short operations (a few seconds at
 * the most.) If you need to keep threads running for long periods of time, it is highly recommended you use the various
 * APIs provided by the <code>java.util.concurrent</code> pacakge such as {@link java.util.concurrent.Executor},
 ...
 * </p>
 * <ol>
 * <li>{@link #onPreExecute()}, invoked on the UI thread before the task is executed. This step is normally used to
 * setup the task, for instance by showing a progress bar in the user interface.</li>
 ...
 * </p>
 * <ul>
 * <li>The AsyncTask class must be loaded on the UI thread.</li>
...
public abstract class CompatibleAsyncTask<Params, Progress, Result> {
	 ...
	 * multiple tasks to operate in parallel. If you truly want parallel execution, you can use the
	 * {@link #executeOnExecutor} version of this method with {@link #THREAD_POOL_EXECUTOR}; however, see commentary
	 ...
	 *             If {@link #getStatus()} returns either {@link CompatibleAsyncTask.Status#RUNNING} or
	 *             {@link CompatibleAsyncTask.Status#FINISHED}.
	 ...
	 * pool of threads managed by AsyncTask, however you can also use your own {@link java.util.concurrent.Executor} for
	 * custom behavior.
	 * <p/>
	 * <p>
