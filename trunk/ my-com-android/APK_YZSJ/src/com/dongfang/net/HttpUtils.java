...
import com.dongfang.net.http.RetryHandler;
import com.dongfang.net.http.SyncHttpHandler;
import com.dongfang.net.http.client.HttpGetCache;
import com.dongfang.net.http.client.HttpRequest;
import com.dongfang.net.http.client.RequestParams;
import com.dongfang.net.http.client.ResponseStream;
import com.dongfang.net.http.client.callback.HttpRedirectHandler;
import com.dongfang.net.http.client.entity.GZipDecompressingEntity;
import com.dongfang.utils.HttpException;
import com.dongfang.utils.core.SimpleSSLSocketFactory;
...
//    public final static HttpGetCache sHttpGetCache = new HttpGetCache();
    ...
    private ResponseStream sendSyncRequest(HttpRequest request, RequestParams params, String contentType) throws com.dongfang.utils.HttpException {
        if (contentType != null) {
            request.setHeader("Content-Type", contentType);
        }
