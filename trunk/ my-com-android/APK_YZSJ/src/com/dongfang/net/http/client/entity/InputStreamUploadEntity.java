...
package com.dongfang.net.http.client.entity;
...
/**
 * Created with IntelliJ IDEA. User: wyouflf Date: 13-6-28 Time: 上午12:14
 */
public class InputStreamUploadEntity extends AbstractHttpEntity implements UploadEntity {
	...
	/**
	 * @deprecated Either use {@link #getContent()} and call {@link java.io.InputStream#close()} on that; otherwise call
	 *             {@link #writeTo(java.io.OutputStream)} which is required to free the resources.
	 */
