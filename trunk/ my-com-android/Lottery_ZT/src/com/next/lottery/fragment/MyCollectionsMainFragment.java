...
public class MyCollectionsMainFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		// if (view == null) {
		View view = inflater.inflate(R.layout.fragment_my_collections_main, container, false);
	...
	public void setViewPager(ArrayList<ShopCartsInfo> shopCartslist) {
		try {
			fragmentAdapter = new MyCollectionsFragmentAdapter(getChildFragmentManager(), shopCartslist);
