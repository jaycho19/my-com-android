...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	private final OnClickListener			mTabClickListener	= new OnClickListener() {
																	public void onClick(View view) {
																		...
																		final int oldSelected = mViewPager
																				.getCurrentItem();
	...
	private void addTab(int index, CharSequence text, int iconResId, int count) {
		...
		tabView.setBackground(getResources().getDrawable(R.drawable.search_activity_tab_tv_color));
	...
	public void setCurrentItem(int item) {
		if (mViewPager == null) {
			ULog.e("ViewPager has not been bound.");
			return;
