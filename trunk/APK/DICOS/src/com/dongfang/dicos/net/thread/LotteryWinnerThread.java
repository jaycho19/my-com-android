...
public class LotteryWinnerThread extends Thread {

	public static final String	tag	= "LotteryWinnerThread";

	private Handler				handler;
	private Context				context;
	private String				phoneNumber;

	public LotteryWinnerThread(Context context, Handler handler, String phoneNumber) {
	...
	@Override
	public void run() {
		String result = new HttpActions(context).lotteryWinner(phoneNumber);
		ULog.d(tag, result);
		...
		msg.setData(data);
		msg.what = ComParams.HANDLER_RESULT_LOTTERYWINNER;
