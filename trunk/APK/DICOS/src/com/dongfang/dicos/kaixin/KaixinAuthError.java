...
public class KaixinAuthError extends RuntimeException {
	...
	public KaixinAuthError(String error, String errorDescription, String errorUri) {
	...
	public static JSONObject genJSONObjectError(String error, String errorDescription, String errorUri) {
		if (error == null)
			error = "";
		if (errorUri == null)
			errorUri = "";
