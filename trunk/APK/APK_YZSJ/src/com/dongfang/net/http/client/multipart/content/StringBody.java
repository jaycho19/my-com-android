...
public class StringBody extends AbstractContentBody {
	 ...
	 * @param charset
	 *            the character set, may be {@code null}, in which case the UTF-8 charset is used
	...
	/**
	 * Create a StringBody from the specified text. The mime type is set to "text/plain". The hosts default charset is
	 * used.
	 * 
	 * @param text
	 *            to be used for the body, not {@code null}
