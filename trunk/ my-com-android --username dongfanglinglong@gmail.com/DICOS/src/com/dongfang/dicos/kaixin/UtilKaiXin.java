...
public class UtilKaiXin {
	...
	public static String openUrl(Context context, String requestURL, String httpMethod, Bundle params,
		...
		conn.setRequestProperty("User-Agent", System.getProperties().getProperty("http.agent") + " KaixinAndroidSDK");
		...
		if (!httpMethod.equals("GET")) {
			...
			String BOUNDARY = UtilKaiXin.md5(String.valueOf(System.currentTimeMillis())); // 数据分隔线
			String endLine = "\r\n";
			...
			// }
			// } catch (Exception e) {
			// ULog.e(LOG_TAG, "Exception on closing input stream"+
			// e.toString());
			// }
			// }
