...
public class LotteryHistoryThread extends Thread {
	...
	public LotteryHistoryThread(Context context, Handler handler, String phoneNumber) {
	...
	@Override
	public void run() {
		String result = new HttpActions(context).lotteryHistory(phoneNumber);
		ULog.d(tag, result);
		...
		msg.setData(data);
		msg.what = ComParams.HANDLER_RESULT_LOTTERYHISTORY;
